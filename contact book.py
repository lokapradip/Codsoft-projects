...
root.title('Pythonloka Contact Book')
root.resizable(0,0)
contactlist = [
    ['Samrudhi oke','369854712'],
    ['gurumith agarwal', '521155222'],
    ['king loka', '78945614'],
    ['monish', '58745246'],
    ['shardha kapoor', '5846975'],
    ['harish', '5647892'],
    ['Samson javiet', '89685320'],
    ['mohan raj', '98564785'],
    ['surya','85967412']
    ]
Name = StringVar()
...
select = Listbox(frame, yscrollcommand=scroll.set, font=('Times of India' ,16), bg="#f0fffc", width=20, height=20, borderwidth=3, relief= "groove")
...
Select_set()
Label(root, text = 'Name', font=("Times of India",22,"bold"), bg = 'SlateGray3').place(x= 30, y=20)
Entry(root, textvariable = Name, width=30).place(x= 200, y=30)
Label(root, text = 'Contact No.', font=("Times of India",20,"bold"),bg = 'SlateGray3').place(x= 30, y=70)
